...
void cmd_memfill(char *tr[]) {
    ...
    void *mem;
    size_t cont; //DICE LEGIDE QUE ESTO ESTA MAL PORQUE SI NO LE PONES VALOR AL CONT VA MAL, TIENE QUE TENER DEFAULT
    unsigned char byte = ' ';
...
void cmd_memdump(char *tr[]) {
    void *mem;
    size_t cont; //DOPA AQUI TENDRIA QUE IMPRIMIR 25 DE DEFAULT, RECOMIENDAN HACERLO COMO EL PROFE
    //char *ptr;
